...
import (
	...
	communicatorMocks "github.com/solidassassin/session-manager-plugin/src/communicator/mocks"
	"github.com/solidassassin/session-manager-plugin/src/config"
	"github.com/solidassassin/session-manager-plugin/src/encryption"
	"github.com/solidassassin/session-manager-plugin/src/encryption/mocks"
